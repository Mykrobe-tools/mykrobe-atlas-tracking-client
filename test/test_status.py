...
from tracking_client.models.status import Status  # noqa: E501
...
class TestStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tracking_client.models.status.Status()  # noqa: E501
        if include_optional :
            return Status(
                de_contamination = 'pending', 
                qc = 'pending', 
                variant_calling = 'pending', 
                prediction = 'pending', 
                bigsi_building = 'pending', 
